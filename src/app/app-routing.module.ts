...
const routes: Routes = [
    ...
    {path: 'chamados/:idFila', component: ChamadosComponent},
    {path: 'chamados/:idFila/adicionaChamado', component: AdicionaChamadoComponent},
    {path: 'chamados/detalhes/:idChamado', component: DetalhesChamadoComponent}
]
